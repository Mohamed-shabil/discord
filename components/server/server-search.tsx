...
import { CommandDialog, CommandEmpty, CommandList,CommandInput, CommandGroup, CommandItem } from "@/components/ui/command";
    ...
    return (
        <>
            <button
                ...
                <Search className="w-4 h-4 text-zinc-500 dark:text-sinc-400"/>
